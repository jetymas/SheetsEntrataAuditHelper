const BaseAuditType = require('../src/js/audit-types/base-audit');
...
describe('BaseAuditType', () => {
  ...
  test('setUp throws error', async () => {
    await expect(audit.setUp()).rejects.toThrow('setUp() method must be implemented by subclass');
  });

  test('findNext throws error', async () => {
    await expect(audit.findNext()).rejects.toThrow('findNext() method must be implemented by subclass');
  });

  test('filterRecords throws error', () => {
    expect(() => audit.filterRecords()).toThrow('filterRecords() method must be implemented by subclass');
  });
